 ...
 *
 * SSL/TLS/DTLS/WiMAX/WiFi/MacSec protocol info macros are omitted
 * (not needed for IPsec).  PKHA copy-memory mode details are also
 * omitted.  Add them back from the Linux original if needed.
 *
